...
public class LogicPanelTimelineRenderTests
{
    ...
    public void TimelineSection_WithEvents_RendersRows()
    {
        ...
        try
        {
            ...
            textBlocks.Any(t => t.Text == logic.TimelineEvents[0].TimeText)
                .ShouldBeTrue("the first row shows its time");
            ...
            textBlocks.Any(t => t.Text == logic.TimelineEvents[1].TimeText)
                .ShouldBeTrue("the second row shows its time");
