...
- Onboarding (principle 1): #1048 (one-click Examples) and #768 (examples in release bundles) shipped; #769 (first-steps tutorial) — slice 1 scoped as #1080 (step engine + place→connect→simulate, worker claimed 2026-08-19); #1089 (NAND2TETRIS-style learning-path order + localized descriptions for the Examples section)
