...
/// </summary>
/// <param name="Id">
/// Stable, unique identifier of the label's owner (e.g. a component's <c>Identifier</c>),
/// also used as the deterministic tie-breaker between equal-priority candidates so the same
/// overlap always resolves the same way — no flicker as the pointer moves.
/// </param>
...
public readonly record struct LabelCandidate(string Id, Rect Bounds, LabelPriority Priority);
